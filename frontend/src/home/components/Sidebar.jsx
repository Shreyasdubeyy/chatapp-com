            ...
            <div className='flex justify-between gap-2'>
                <form onSubmit={handelSearchSubmit} className='w-auto flex items-center justify-between bg-white rounded-full '>
                    <input
                        ...
                        type='text'
                        className='px-4 w-auto bg-transparent outline-none rounded-full text-gray-900'
                        ...
                        <div className='w-auto'>
                            {searchUser.map((user, index) => (
                                <div key={user._id}>
                                    ...
                                    <div className='divider divide-solid px-3 h-[1px] bg-gray-600'></div>
                                </div>
                            ))}
                        </div>
                    </div>
                            ...
                            {chatUser.length === 0 ? (
                                ...
                                chatUser.map((user, index) => (
                                    <div key={user._id}>
                                        ...
                                        <div className='divider divide-solid px-3 h-[1px] bg-gray-900'></div>
                                    </div>
                                ))
                            )}
                        </div>
